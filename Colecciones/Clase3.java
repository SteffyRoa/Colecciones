...
public class Clase3 {
    ...
    public static void main(String[] args) {
        ...
        // ordenar de forma ascendente - Collections - SORT
        Collections.sort(cursos);
        // ordenar forma descendente - Collections Clase SORT
        Collections.sort(cursos, Collections.reverseOrder());
        System.out.println(cursos);

        cursos.sort(Comparator.naturalOrder());
        cursos.stream().sorted().collect(Collectors.toList());
        // utilizar del Arraylist
        // menor a mayor
        cursos.sort(Comparator.reverseOrder());
        System.out.println(cursos);
        // Orden UTILIZANDO STREAM
        // collect devuelve lista nueva
